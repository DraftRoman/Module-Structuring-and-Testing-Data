...
// Case 6: Identify the ordinal number for 20th
...
// Case 8: Identify the ordinal number for 111-114
...
test("should return '114th' for 114", () => {
    expect(getOrdinalNumber(114)).toEqual("114th");
});
// Case 9: Identify the ordinal number for 0
...
test("should return '1000001st' for 1000001", () => {
    expect(getOrdinalNumber(1000001)).toEqual("1000001st");
});
// Case 12: Invalid input (negative numbers)
...
// Case 14: Invalid input (null or undefined)
